...
import 'package:storyteller/util/ads/interstler_ads.dart';
...
class _StoryScreenState extends State<StoryScreen> {
  ...
  void initState() {
    ...
    bannerAd = BannerAd(
      adUnitId: KeyConstants.bannerAddKey,
  ...
  Widget build(BuildContext context) {
    return isLoaded == false
        ...
        : ChangeNotifierProvider<StoryDetailsProvider>(
            create: (context) =>
                StoryDetailsProvider()..getStory(widget.storyId),
